...
// var connection = new WebSocket("ws://149.28.166.147:12345");
...
var startGame = function () {
  ...
  Game.setBoard(3, new TitleScreen("Komodo TX Blaster!",
...
var PlayerMissile = function (x, y) {
  ...
  console.log("MISSILE");
    connection.send('MISSILE'); // Send the message 'Ping' to the server
  this.x = x - this.w / 2;
  this.y = y - this.h;
};
